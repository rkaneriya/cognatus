  ...
  return (
    <div className="flex items-center">
      ...
      <Tooltip
        placement="top"
        title={
          "Share a read-only version of your tree with anyone who has a link to it."
        }
      >
  ...
  return (
    <div className="flex items-center">
      ...
      <Tooltip
        placement="top"
        title={
          "If checked, you will receive an e-mail on the first of every month reminding you of upcoming birthdays and anniversaries of members of this tree. You can un-check this box to stop receiving e-mails at any time."
        }
      >
        <QuestionCircleOutlined style={{ marginLeft: "10px" }} />
      </Tooltip>
  ...
  const TREE_COLUMNS = [
    {
      ...
      width: "15%",
      render: (text, record) => (
        <Typography.Link href={`/trees/${record.uuid}`}>{text}</Typography.Link>
      ),
    },
    {
      title: "Description",
    ...
    <div className="p-10">
      ...
      <Section>
        <div className="flex justify-between items-center w-full">
          <Title level={2}>Your trees ({treeCount})</Title>
          <Button
        ...
        <EditableTable columns={TREE_COLUMNS} />
      </Section>

      <Section>
        <div
          className={`flex justify-between items-center w-full ${treeCount === 0 && "mt-10"}`}
        >
          <Title level={2}>Trees shared with you ({sharedTreeCount})</Title>
        </div>
        <Table
          bordered
