...
function TreeMobile({ data, updateTree }) {
  const { uuid, name, description, is_email_subscribed, sharer_email } = data;
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <Typography.Link href={`/trees/${uuid}`}>
  ...
  const TREE_COLUMNS = [
    {
      ...
      key: "",
      render: (_, record) => (
        <TreeMobile data={record} updateTree={updateTree} />
      ),
    },
  ];
