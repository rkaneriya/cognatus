...
export default function MemberDrawer({
  ...
  function handleFinish(values) {
    ...
    if (
      drawerConfig === MEMBER_RELATION_ACTIONS.ADD_NEW_PARENT ||
      drawerConfig === MEMBER_RELATION_ACTIONS.ADD_NEW_CHILD
    ) {
  ...
  const submitLabel =
    drawerConfig === MEMBER_RELATION_ACTIONS.EDIT_MEMBER ? "Edit" : "Add";
      ...
      >
        ...
        <Form.Item
          ...
          shouldUpdate={(prev, curr) =>
            prev.use_year_only !== curr.use_year_only
          }
        >
          {({ getFieldValue }) => (
            <Form.Item
            ...
            >
              <DatePicker
                picker={
                  getFieldValue("use_year_only") === "true"
                    ? "year"
                    : "undefined"
                }
              />
